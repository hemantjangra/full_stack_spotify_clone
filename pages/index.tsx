...
import { useCurrentLoggedInUser } from "../lib/hooks";

const Home = ({ artists, color }) => {
  const { user, isLoading, isError } = useCurrentLoggedInUser();
  ...
  return (
    <GradientLayout
      ...
      subtitle="Profile"
      description={`${user?.playlistCount} playlist and counting`}
      color={color}
      roundedImage={true}
    >
